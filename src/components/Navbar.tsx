...
export default function Navbar() {
  return (
    <header className='w-full z-50 justify-between flex items-center p-3 2xl:p-5 fixed top-0 bg-white dark:bg-primary-700'>
        <div className='flex justify-start items-center gap-4'>
            ...
            <Link href={"#"} className='text-primary-600 dark:text-primary-100 hover:text-primary-700 dark:hover:text-primary-50 hover:underline text-sm md:hidden uppercase'>Home</Link>
        ...
        <div className='flex justify-start items-center gap-4'>
            <Link href={"/"} className='text-primary-600 dark:text-primary-100 hover:text-primary-700 dark:hover:text-primary-50 hover:underline text-sm hidden md:block'>Home</Link>
